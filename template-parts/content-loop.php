...
<article id="post-<?php the_ID(); ?>" <?php post_class('bg-white p-2 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300'); ?>>
    ...
    <header class="mb-3">
        <span class="bg-primary px-2 py-1 rounded text-sm text-white italic">
